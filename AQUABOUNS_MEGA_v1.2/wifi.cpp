...
const char texteSurSD7[] PROGMEM = "reboot Wifi";
const char texteSurSD16[] PROGMEM = "arduino / wifi Erreur envoi params";
const char texteSurSD17[] PROGMEM = "arduino / wifi envoi params OK";
const char texteSurSD18[] PROGMEM = "arduino / wifi Erreur envoi variables";
const char texteSurSD19[] PROGMEM = "arduino / wifi envoi variables OK";
const char texteSurSD20[] PROGMEM = "arduino / wifi Erreur envoi identifiantWifi";
const char texteSurSD21[] PROGMEM = "arduino / wifi envoi identifiantWifi OK";
const char texteSurSD22[] PROGMEM = "arduino / wifi Erreur envoie connectionWifi";
const char texteSurSD23[] PROGMEM = "arduino / wifi envoie connectionWifi OK";
const char texteSurSD24[] PROGMEM = "arduino / wifi Erreur reception params";
const char texteSurSD25[] PROGMEM = "arduino / wifi reception params OK";
const char texteSurSD26[] PROGMEM = "arduino / wifi Erreur reception variables";
const char texteSurSD27[] PROGMEM = "arduino / wifi reception variables OK";
const char texteSurSD28[] PROGMEM = "arduino / wifi Erreur reception identifiantWifi";
const char texteSurSD29[] PROGMEM = "arduino / wifi reception identifiantWifi OK";
const char texteSurSD30[] PROGMEM = "arduino / wifi Erreur reception connectionWifi";
const char texteSurSD31[] PROGMEM = "arduino / wifi reception connectionWifi OK";
  ...
  switch (uneCommande) {
    case ENVOYERsauvegarde:
      ...
      if (!envoyerData((uint8_t *) &sauvegarde, tailleParamS_t )) { // si la structure envoyer ne correspond pas a la structure demandée
        ...
        horodatageEtEcritSurSD (texteSurSD16, "");
      }
      else { // sinon c'est OK
        DPRINTF("params envoyer"); DPRINTLN();
        horodatageEtEcritSurSD (texteSurSD17, "");
      }
      break;
    ...
    case ENVOYERvariable:
      ...
      if (!envoyerData((uint8_t *) &variable, taillevaleursActuel_t )) { // si la structure envoyer ne correspond pas a la structure demandée
        ...
        horodatageEtEcritSurSD (texteSurSD18, "");
      }
      else { // sinon c'est OK
        DPRINTF("variables envoyer"); DPRINTLN();
        horodatageEtEcritSurSD (texteSurSD19, "");
      }
      break;
    ...
    case ENVOYERidentifiantWifi:
      ...
      if (!envoyerData((uint8_t *) &identifiantWifi, tailleidentifiantDeConnection_t )) { // si la structure envoyer ne correspond pas a la structure demandée
        ...
        horodatageEtEcritSurSD (texteSurSD20, "");
      }
      else { // sinon c'est OK
        DPRINTF("identifiantWifi envoyer"); DPRINTLN();
        horodatageEtEcritSurSD (texteSurSD21, "");
      }
      break;
    ...
    case  RECEVOIRvariable:
      ...
      if (!recevoirData((uint8_t *) &variable, taillevaleursActuel_t)) { // si la structure demander ne correspond pas a la structure recu
        ...
        horodatageEtEcritSurSD (texteSurSD26, "");
      }
      else { // sinon c'est OK
        DPRINTF("variables recu"); DPRINTLN();
        horodatageEtEcritSurSD (texteSurSD27, "");
      }
    ...
    case  RECEVOIRidentifiantWifi:
      ...
      if (!recevoirData((uint8_t *) &identifiantWifi, tailleidentifiantDeConnection_t)) { // si la structure demander ne correspond pas a la structure recu
        ...
        horodatageEtEcritSurSD (texteSurSD28, "");
      }
      else { // sinon c'est OK
        DPRINTF("identifiantWifi recu"); DPRINTLN();
        horodatageEtEcritSurSD (texteSurSD29, "");
      }
      break;
...
void etatWifi() {
  ...
  if (connectionWifi.presenceModule == false) {
    horodatageEtEcritSurSD (texteSurSD7, "");
